...
class HTMLPurifier_Encoder
{
     ...
     *       maintenance/generate-entity-HTMLPurifier_URIScheme_file.php (although this is superior,
    ...
    {
        set_error_handler(array('Security\htmlpurifier\HTMLPurifier\HTMLPurifier_Encoder', 'muteErrorHandler'));
        $r = iconv($in, $out, $text);
