...
use Security\HTMLPurifier\HTMLPurifier\HTMLPurifier_Exception;
...
use Security\HTMLPurifier\HTMLPurifier\HTMLPurifier_Zipper;
use Security\HTMLPurifier\HTMLPurifier\Token\HTMLPurifier_Token_Empty;
use Security\HTMLPurifier\HTMLPurifier\Token\HTMLPurifier_Token_End;
...
class HTMLPurifier_Strategy_MakeWellFormed extends HTMLPurifier_Strategy
{
    ...
    public function execute($tokens, $config, $context)
    {
        ...
        foreach ($injectors as $injector => $b) {
            ...
            $injector = "Security\htmlpurifier\HTMLPurifier\Injector\HTMLPurifier_Injector_$injector";
            if (!$b) {
                continue;
            }
