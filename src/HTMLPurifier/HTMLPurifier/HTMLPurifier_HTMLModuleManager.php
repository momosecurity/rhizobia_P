...
class HTMLPurifier_HTMLModuleManager
{
    ...
    public function registerModule($module, $overload = false)
    {
        if (is_string($module)) {
            ...
            if (strpos($original_module, 'Tidy_') !== false) {
                $namespace_this = 'Security\\htmlpurifier\\HTMLPurifier\\HTMLModule\\Tidy\\';
            } else {
                $namespace_this = 'Security\\htmlpurifier\\HTMLPurifier\\HTMLModule\\';
            }
            $ok = false;
            foreach ($this->prefixes as $prefix) {

                $module = $namespace_this . $prefix . $original_module;
        ...
        foreach ($this->modules as $module) {
            ...
            foreach ($module->info_injector as $injector) {
                if (!is_object($injector)) {
                    $class = "Security\htmlpurifier\HTMLPurifier\Injector\HTMLPurifier_Injector_$injector";
                    $injector = new $class;
                }
